...
{
    [ExportCodeFixProvider("ReturnValueNotUsedAnalyzerCodeFixProvider", LanguageNames.CSharp), Shared]
    public class ReturnValueNotUsedAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> GetFixableDiagnosticIds()
        {
            return ImmutableArray.Create(ReturnValueNotUsedAnalyzerAnalyzer.DiagnosticId);
        }
